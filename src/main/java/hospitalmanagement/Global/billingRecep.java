 ...
 * @author ACER
 */
public class billingRecep extends javax.swing.JFrame {

    /**
     * Creates new form billingRecep
     */
    public billingRecep() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        backButton.setBackground(new java.awt.Color(242, 121, 53));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(billingRecep.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new billingRecep().setVisible(true);
            }
        });
    }
